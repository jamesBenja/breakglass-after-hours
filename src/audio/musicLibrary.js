...
export const APPROVED_DJ_INGEST = [
  ['team-break', 'James Benjamin · Team Break', 'Dance Beyond Genre Vol. 1', '1sNTb0aOzS09o874S7rmfppHgwIcwlLcf'],
  ['ancillary-things', 'James Benjamin · Ancillary Things', 'Dance Beyond Genre Vol. 1', '1sNTb0aOzS09o874S7rmfppHgwIcwlLcf'],
  ['gairage', 'James Benjamin × Jamvvis · Gairage', 'Gairage', '1RtHx6LA5mmbijBLvIWaaWtPxESCNRayq'],
  ['hit-the-floor', 'James Benjamin ft Star Amerasu + Kizaba · Hit the Floor', 'Singles', '1RLCmVvPfNh07KhHRA93AsKuqmLTPqUB5'],
  ['chi-town-drop', 'James Benjamin ft AmirSaysNothing · Chi Town Drop', 'Singles', '1RLCmVvPfNh07KhHRA93AsKuqmLTPqUB5'],
  ['drop-in', 'James Benjamin · Drop In', 'Got You Dancin', '10Mb4ssBEBh9yGzuR19liBArUrd4RDbEf'],
  ['body-check', 'James Benjamin · Body Check', 'Got You Dancin', '10Mb4ssBEBh9yGzuR19liBArUrd4RDbEf'],
  ['play-ball-people', 'James Benjamin · Play Ball (People)', 'Got You Dancin', '10Mb4ssBEBh9yGzuR19liBArUrd4RDbEf'],
  ['etcetera', 'James Benjamin · Etcetera', 'Got You Dancin', '10Mb4ssBEBh9yGzuR19liBArUrd4RDbEf'],
  ['airtime-express', 'James Benjamin · Airtime Express', 'Got You Dancin', '10Mb4ssBEBh9yGzuR19liBArUrd4RDbEf'],
  ['rotations-the-roll', 'Boogieman · The Roll', 'Rotations', '1rWm-iTt0NS89Rj1T9oXsj55jJi8kcaxb'],
  ['rotations-den-naben', 'Boogieman · Den Naben', 'Rotations', '1rWm-iTt0NS89Rj1T9oXsj55jJi8kcaxb'],
  ['rotations-water-is-boiling', 'Boogieman · Water Is Boiling', 'Rotations', '1rWm-iTt0NS89Rj1T9oXsj55jJi8kcaxb'],
  ...
  ['rotations-devils-mountain', 'Boogieman · Devils Mountain and Ngorongoro Crater', 'Rotations', '1rWm-iTt0NS89Rj1T9oXsj55jJi8kcaxb'],
  ['rotations-fences', 'Boogieman · Fences', 'Rotations', '1rWm-iTt0NS89Rj1T9oXsj55jJi8kcaxb'],
  ['rotations-water-is-boiling-outro', 'Boogieman · Water Is Boiling (Outro)', 'Rotations', '1rWm-iTt0NS89Rj1T9oXsj55jJi8kcaxb'],
  ['guestlist-andy-s', 'James Benjamin ft Andy S · Guestlist', 'Singles', '143l1B1T07K3TJrMiTv3FHQqjGObh6Boj'],
...
export const APPROVED_AMBIENT_INGEST = [
  ['mfteot-nature-waterfall-rebirth', 'Waterfall Rebirth', 'NATURE', '1TKGxeDoIqA314b-qppDK1lhzvSfYiwSN'],
  ['mfteot-nature-birds-at-the-sinks', 'The Birds at the Sinks', 'NATURE', '1TKGxeDoIqA314b-qppDK1lhzvSfYiwSN'],
  ['mfteot-nature-zona', 'Zona', 'NATURE', '1TKGxeDoIqA314b-qppDK1lhzvSfYiwSN'],
  ['mfteot-nature-cellular-imaginings', 'Cellular Imaginings 1', 'NATURE', '1TKGxeDoIqA314b-qppDK1lhzvSfYiwSN'],
...
export const APPROVED_STUDIO_SOURCES = [
  ...
  ['soundscape-jashim-jb', 'Soundscape · Jashim × James Benjamin', null, '1m8m1oTDxLx4Lry6NB1slpeMpUF6mG366'],
  ['feedback-loop-stems', 'Feedback Loop · stems', '145', '1Da5gwERMxGeYnBXjrsnjoyZaNR7uuHTb'],
  ['babizulu-140-stems', 'James Benjamin ft Babizulu · stems', '140', '1WQ_7Y2rEwy39H58u4Wu9upVYY6kM5qZw'],
  ['umbrella-jolani-stems', 'Umbrella · James Benjamin × Jolani · stems', null, '1tIjDFuTJukMTb2VWRJa2ny0Y1fkPlHdb'],
  ...
  ['planet-pillow-stems', 'Lunice × James Benjamin × Pax · Planet Pillow', null, '1_Fza_e5CUCE6R9bCKE8qwEOg-jKsxhpi'],
  ['kizaba-future-village-stems', 'Kizaba · Future Village stem collection', '85–161', '1CfmFKjeA7sSwRvR8EegmR3DjT8tiuRf6'],
  ['la-loft-11-lunice-stems', 'LA Loft 11 · stems for Lunice', null, '198xHUIc6BRA7AkXvn-XidtRVuhis9Y-n'],
  ['pro-stems-91', 'Unfinished studio session · 91 BPM', '91', '13IEY9J6q66wmhO3WOiIHwiNVWA5HM7pg'],
  ['pro-session-stems-88', 'Unfinished studio session · 88 BPM', '88', '1bUBAA7JjnPy8Kwllyjvrb_ZlvZ3bT77O'],
...
export const APPROVED_LONGFORM_SOURCES = [
  ['james-nts-club-aerobics-2025', 'James Benjamin · NTS Club Aerobics', '1vI9AQ6iRf9s1hHUN1UizJ7BG_tA8uNCe', 'dj-mix'],
  ['james-datcha-isa-jamvvis-2024', 'James Benjamin / Isa Boom / Jamvvis · Datcha', '1vs8K5TgOwXW-BHLiyXPjh-7BHmPEgO01', 'dj-mix'],
  ['james-jamvvis-dotdotdot-2024', 'James Benjamin b2b Jamvvis · DotDotDot', '1OnEuDQVIHZKSMKqiCLWVG6kcNF4THpk7', 'dj-mix'],
  ['james-mal-necessaire-2024', 'James Benjamin · Mal Nécessaire', '1f0qnG-m8uM6RujHOs5finI3i1PzSiqeT', 'dj-mix'],
  ['james-mess-du-dimanche-2024', 'James Benjamin · Mess du Dimanche 001', '1lxOmETjHS2aCmcvvIGdyrHuBnNKMS7Xc', 'dj-mix'],
  ['james-systeme-2023', 'James Benjamin · Système', '1FiW6TErG6BQuVSVocdB2gUE-M1YgFr0H', 'dj-mix'],
  ['james-night-shift-2023', 'James Benjamin · Night Shift', '14K7HfSzmR2o797knVENwKdxJhWO7r9Mi', 'dj-mix'],
  ['james-datcha-2023', 'James Benjamin · Datcha', '1-Q7mqM77FJjF_WgFqowo2TLz-ZqVdoEX', 'dj-mix'],
  ['james-quan-non-stop-2023', 'James Benjamin × Quan · Non Stop', '1K41gOL7zObFDf0C39mzVNkug5t1YEjVo', 'live-set'],
  ['james-quan-homeby6-2024', 'James Benjamin × Quan · Breakglass × Homeby6', '1uNmGIDOeL46h9TnReGoiX9_mvv3X_ogO', 'live-set'],
  ['james-dj-rehearsal-2026', 'James Benjamin · DJ rehearsal', '1Ss8QTl8je1I5blur9mI9lg3gd89ydfJL', 'video-source'],
