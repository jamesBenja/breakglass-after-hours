...
const HINTS = {
  storage: {
    ...
    medium:
      'Storage is staff access. Someone on the studio floor who knows the archive history can open it for you.',
    hard: 'Storage is locked.',
  },
  'dead-room': {
    easy: 'The Dead Room is locked. Find Boogaloo upstairs and ask which guitars and amps belong together.',
    medium:
      'The Dead Room is locked. One of the artists upstairs knows the guitar and amp setup well enough to let you in.',
  ...
  shortcut: {
    ...
    medium:
      'A strange keyway is built into the service-stair door. The Spectra console may have something to do with it.',
